...
import '../../auth/widgets/recovery_access_sheet.dart';
...
class ProfileTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final recoveryConfigured =
        ref.watch(accountRecoveryServiceProvider).isRecoveryConfigured;
      ...
      child: Column(children: [
        ...
        _SettingsTile(
          ...
          subtitle: user?.email?.isNotEmpty == true
              ? user!.email!
              : 'Add an email for account communication',
          trailing: const Icon(Icons.edit_outlined, size: 18),
          onTap: () => _updateEmail(context, ref, user?.email),
        ...
        _SettingsTile(
          ...
          subtitle: recoveryConfigured
              ? 'Recovery email is linked'
              : 'Protect your ledger if your phone is lost',
          trailing: recoveryConfigured
              ? const Icon(Icons.verified_rounded,
                  color: AppColors.success, size: 20)
              : null,
          onTap: recoveryConfigured
              ? null
              : () => _configureRecovery(context, ref, user?.email),
        ...
        Text(
          'Made in India\nLenDen - ${AppConstants.appTagline}',
          style: GoogleFonts.poppins(
              fontSize: 11, color: cs.onSurface.withOpacity(0.3), height: 1.6),
  ...
  Future<void> _updateEmail(
    ...
    final email = await showContactEmailDialog(
      context,
  ...
  Future<void> _configureRecovery(
    BuildContext context,
    WidgetRef ref,
    String? initialEmail,
  ) async {
    final configured = await showRecoveryAccessSheet(
      context,
      configure: true,
      initialEmail: initialEmail,
    );
    if (configured != true || !context.mounted) return;
    ref.invalidate(accountRecoveryServiceProvider);
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
      content: Text(
        'Verification email sent. Verify it before relying on recovery sign-in.',
      ),
      behavior: SnackBarBehavior.floating,
    ));
  }
        ...
        child: Column(
            ...
            children: [
              ...
              _HelpRow(
                  ...
                  onTap: () async {
                    final subj2 =
                        Uri.encodeComponent('LenDen — Data Deletion Request');
            ...
            child: ListView(
              ...
              children: const [
                ...
                _FaqItem(
                  ...
                  a: 'No. Your ledger stays in the cloud. Configure Account Recovery in Profile before losing access, verify the email, then use Recovery sign in on a new device.',
                ),
                _FaqItem(
          ...
          Expanded(
            ...
            children: [
              _PolicySection(
                ...
                body:
                    'We collect your mobile number for authentication, and the names, phone numbers, '
                    'and transaction amounts that you enter into the app.',
              ),
              _PolicySection(
                title: 'How We Use Your Data',
                body:
                    'Your data is used solely to provide the LenDen ledger service. '
                    'We do not sell, share, or use your data for advertising.',
              ),
              _PolicySection(
                title: 'Data Storage',
                body:
                    'All data is stored securely on Google Firebase (Firestore) with industry-standard '
              ...
              _PolicySection(
                ...
                body:
                    'We use Firebase (by Google) for authentication and data storage. '
                    'Firebase\'s privacy policy is available at firebase.google.com.',
              ),
              _PolicySection(
                title: 'Contact',
                body:
                    'For privacy concerns, data deletion requests, or questions: ${AppConstants.supportEmail}',
              ),
              const SizedBox(height: 8),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        Text(AppFormatters.phone(phone),
            style: GoogleFonts.poppins(
