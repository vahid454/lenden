...
class _DashboardPageState extends ConsumerState<DashboardPage> {
  ...
  static const _pages = [_HomeTab(), ReportsPage(), SizedBox()]; // Profile is inline
  ...
  AppBar _buildAppBar(BuildContext context, WidgetRef ref, String name) {
    final titles = ['Home', 'Reports', 'Profile'];
    return AppBar(
      title: _navIndex == 0
          ? Column(
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(
                children: [
                  _NetBalanceHero(net: net, toReceive: toReceive, toPay: toPay)
                  ...
                  if (i == preview.length) {
                    return Padding(
                      ...
                      child: OutlinedButton(
                        ...
                        child: Text('View all ${customers.length} customers',
...
class _NetBalanceHero extends StatelessWidget {
  final double net; final double toReceive; final double toPay;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            net == 0 ? '✓ All accounts settled'
                : isPositive ? 'Overall you will receive'
...
class _NetChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20)),
    child: Text(label, style: GoogleFonts.poppins(fontSize: 10, color: Colors.white, fontWeight: FontWeight.w500)),
  );
}
      ...
      child: Container(
        ...
        child: Column(children: [
          Container(
            ...
            child: Icon(Icons.group_outlined, size: 36, color: cs.primary.withOpacity(0.5)),
          ...
          Text('Add your first customer to start tracking udhar.',
              style: GoogleFonts.poppins(
                  fontSize: 13, color: cs.onSurface.withOpacity(0.5), height: 1.5),
